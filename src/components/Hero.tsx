...
export function Hero() {
  return (
    <section
      ...
      className="relative bg-lapis-800 overflow-hidden pb-28 pt-10 sm:py-32 md:pt-12"
    >
      <Image
      ...
      <Container className="relative pb-16 pt-20 text-center lg:pt-32">
        <h1 className="text-slate-50 mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight sm:text-7xl">
          Unlocking{' '}
          <span className="relative whitespace-nowrap">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute left-0 top-2/3 h-[0.58em] w-full fill-lapis-400/50"
        ...
        <div className="mt-10 flex justify-center gap-x-6">
          <Button href="/register">Request a door</Button>
          <Button
